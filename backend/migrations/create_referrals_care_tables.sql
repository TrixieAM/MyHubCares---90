-- Create Referrals & Care Coordination Tables
-- Run this migration to create the necessary tables for referrals, counseling sessions, HTS sessions, and care tasks
...
-- Add follow_up_reason column if it doesn't exist (MySQL doesn't support IF NOT EXISTS, so this may fail if column exists)
-- Run this separately if needed: ALTER TABLE counseling_sessions ADD COLUMN follow_up_reason TEXT;

-- 3. hts_sessions table
